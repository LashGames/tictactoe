...
public class GetPlayerNamesDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view=inflater.inflate(R.layout.fragment_get_player_names_dialog,null);
        builder.setView(view)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        dialogListner.onDialogPositiveClick(GetPlayerNamesDialog.this, player1_name.getText().toString(), player2_name.getText().toString());
                    }
                }).setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        GetPlayerNamesDialog.this.getDialog().cancel();
                    }
                });
